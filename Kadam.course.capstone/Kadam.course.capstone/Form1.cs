...
namespace Kadam.course.capstone
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'capstoneDataSet1.Number' table. You can move, or remove it, as needed.
            this.numberTableAdapter1.Fill(this.capstoneDataSet1.Number);
            // TODO: This line of code loads data into the 'capstoneDataSet.Number' table. You can move, or remove it, as needed.
            this.numberTableAdapter.Fill(this.capstoneDataSet.Number);
        ...
        {
            {
                ...
                string course = coursNOComboBox.Text;
                Hello.setno(course);
        ...
        private void numberBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.numberBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.capstoneDataSet);
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.numberTableAdapter1.FillBy(this.capstoneDataSet1.Number);
            }
        ...
        private void coursNOTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void coursNOComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
